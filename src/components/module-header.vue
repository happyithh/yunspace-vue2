        ...
        <nav class="clearfix">
            ...
            <div class="fr">
                <ul class="fl tools clearfix">
                    <li class="">
                        <a target="_blank" href="http://www.yunspace.com.cn/city_painter">城市运营商</a>
                    </li>
                    <li class="spacer"></li>
                    <li class="">
                        <!--<a href="javascript:;" @click="toggleApp">APP下载</a>-->
                        <a target="_blank" href="http://www.yunspace.com.cn/site_join">场地加盟</a>
                    </li>
                    <li class="spacer"></li>
                    <li class="tel">
                        <i class="icon-tel"></i>
...
//            console.log(this.$route)
            ...
            this.$store.commit('cityHotKeyword');
        },
        methods: {
            ...
            cityChange(e){
                ...
                if(!this.firstTime){
                    this.$store.commit('cityChange',e)
                    LS.set('selectedCity',e)
                    if(this.$router.currentRoute.fullPath == '/'){
                        window.bus.$emit('city-selected',e)
                    }else{
                        router.replace('/')
                    }
...
//                router.go('/')
            ...
            toggleApp: function () {
                this.$parent.$data.showForm.showApp = ! this.$parent.$data.showForm.showApp
            }
        }
