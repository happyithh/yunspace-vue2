                        ...
                        <form class="validate-form" action="" id="submit-consult">
                            <ul class="inputbox">
                                ...
                                <li class="inputwrap trea clearfix">
                                    ...
                                    <textarea v-model="consult.consulting_content" name="consult-content" maxlength="300" data-rule-required="true" data-msg-required="请输入咨询内容!"
                                              rows="7" placeholder="您想咨询的内容，300字以内"></textarea>
                                </li>
                            </ul>
        ...
        mounted () {
            ...
            setTimeout(function () {
                if(self.personalData.name){
                    ...
                    self.consult.the_contact = self.personalData.name
                }
            },300)
        },
        methods: {
